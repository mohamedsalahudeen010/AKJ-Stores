...
const SignUpPage = () => {
  ...
  const addUser = async (user) => {
    ...
    try {
      const response = await fetch("https://akj-stores.onrender.com/userSignUp", {
        method: "POST",
 ...
 <div className="signUp-user-main">
      ...
      <div className="Sign_up">
        ...
        <h1 className="signup-title-2-user" >Register Here to be a Part of our Family</h1>

        <form onSubmit={handleSubmit} className="form-signup-user">

        <div className="input-div input1">
                <label className="textlabel" htmlFor="firstName">First Name
           ...
           <div className="input-div input2">
                <label className="textlabel" htmlFor="lastName">Last Name
                <span style={{color:"brown"}}>{" "}*</span></label>
                <input
              className="input-signUp-user"
...
<div className="input-div input1">
                <label className="textlabel" htmlFor="email">E.mail
                <span style={{color:"brown"}}>{" "}*</span></label>
                <input
              className="input-signUp-user"
              placeholder="Email"
            ...
            <div className="input-div input2">
                <label className="textlabel" htmlFor="phone">Phone Number
                <span style={{color:"brown"}}>{" "}*</span></label>
                <input
              className="input-signUp-user"
         ...
         <div className="row" style={{width:"100%",position:"relative",display:"inline-block"}}>
           ...
           <div className="input-div input5">
                <label className="textlabel" htmlFor="password">Password
                <span style={{color:"brown"}}>{" "}*</span></label>
            <input
              className="input-signUp-user"
