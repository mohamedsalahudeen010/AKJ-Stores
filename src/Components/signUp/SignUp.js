  ...
  const addUser = async (user) => {
    try {
      const response = await fetch(
        "https://akj-stores.onrender.com/userSignUp",
        {
          method: "POST",
      ...
      <div className="signUpPage">
        <div className="signUp-user-main">
          <div className="name-title-signUp">
            <h3 className="title-signUp-user">AKJ Stores Welcomes You</h3>
          </div>

          <div className="Sign_up">
            <h1 className="signup-title-2-user">
              Register Here to be a Part of our Family
            </h1>
