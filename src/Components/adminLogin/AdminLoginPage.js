...
const AdminLogInPage = () => {
  ...
  const logInFunc = async (email) => {
    try {
      const response = await fetch("https://akj-stores.onrender.com/adminLogIn", {
        method: "POST",
      ...
      <div>
        ...
        <h2 className="signIn-title-Admin">LogIn As Admin</h2>
          ...
          <div className="input-div">
                <label className="textlabel-signIn" htmlFor="email"
            ...
            {errors.email && touched.email ? (
              ...
              <div className="input-div">
                <label className="textlabel-signIn" htmlFor="password">Password <span style={{color:"brown"}}>*</span></label>
              <input
            ...
            onClick={() => navigate("/forgetPageAdmin")}
        ...
        <div>
          Click Hear to <span onClick={()=>navigate("/adminSignUp")} 
